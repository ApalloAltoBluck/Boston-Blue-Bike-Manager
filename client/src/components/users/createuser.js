...
function CreateUser() {
  ...
  const [userCopy, setUserCopy] = React.useState({firstName:"JANE", lastName: "Doe",
  membership:"STUDENT", email: "john@apple.com", username:"YOUR USERNAME",password: "PASSWORD", dateOfBirth: new Date().toISOString("2021-12-08T05:00:00.000Z").slice(0,10)});
